...
const student1 = new Student("684245066", "kay", "Science");
const student2 = new Student("684245067", "Ploy", "Engineering");
const student3 = new Student("684245068", "Nut", "Business");
const teacher1 = new Teacher("Dr. John", "Mathematics");
const teacher2 = new Teacher("Dr. Downey", "Physics");
